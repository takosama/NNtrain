// FP32 32x32x32 tile for narrow dQ/dK/dV. No precision change or host packing.
// Reduction order matches attention_gemm_narrow; only independent rows split.
__attribute__((reqd_work_group_size(16,16,1)))
__kernel void attention_gemm_compact(__global const float* a,__global const float* b,__global float* c,
